...
export default function ProductOfTheMonth() {
  return (
    <div className={styles.wrapper} id="productOfTheMonth">
      <div className={styles.description}>
        <p className={styles.header1}>Discover our best product according to customers</p>
        <p className={styles.header2}>
          Customization Options: We offer unparalleled customization options, allowing you to tailor
          every aspect of your furniture to suit your unique style and preferences, from choice of
          materials to personalized finishes.
        </p>
        <p className={styles.header2}>
          Craftsmanship Excellence: Our furniture is meticulously crafted by skilled artisans who
          uphold the highest standards of quality and attention to detail, ensuring each piece is a
          masterpiece of durability and aesthetics.
        </p>
        <p className={styles.header2}>
        ...
        <p className={styles.header2}>
          ...
          strive to offer competitive pricing, ensuring that you receive exceptional value for your
          investment in pieces that will adorn your home for years to come.
        </p>
      </div>
